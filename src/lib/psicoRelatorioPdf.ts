...
export function gerarPdfPsicossocial(p: PdfPayload) {
  ...
  for (const g of p.grupos) {
    ...
    y = tabela({
      ...
      columnStyles: {
        0: { cellWidth: 56 }, 1: { cellWidth: 54 }, 2: { cellWidth: 56 }, 3: { cellWidth: 52 },
        4: { cellWidth: 18, halign: "center" }, 5: { cellWidth: 42 },
        6: { cellWidth: 13, halign: "center" }, 7: { cellWidth: 13, halign: "center" },
        8: { cellWidth: 30, halign: "center" }, 9: { cellWidth: 58 }, 10: { cellWidth: 56 },
        11: { cellWidth: 52 },
      },
  ...
  tabela({
    ...
    head: [["Setor / GHE", "Risco", "Medida recomendada", "Tipo", "Resp.", "Prazo", "Prioridade", "Status", "Evidência"].map(textoPdf)],
    columnStyles: {
      0: { cellWidth: 56 }, 1: { cellWidth: 58 }, 2: { cellWidth: 106 }, 3: { cellWidth: 54 },
